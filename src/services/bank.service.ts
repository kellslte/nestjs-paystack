...
import { ListBankBranchesRequest, ListBankBranchesResponse, ListBanksRequest, ListBanksResponse } from '../interfaces/bank.interface';
...
export class BankService extends BaseService {
    ...
    async listBranches(bankId: number, params?: ListBankBranchesRequest): Promise<ListBankBranchesResponse | any> {
