export class PaystackError extends Error {
  ...
  static fromResponse(response: any): PaystackError {
    const message = response.message || 'Paystack API error';
  ...
  static fromHttpError(status: number, message: string, data?: any): PaystackError {
